...
import 'package:final_project_app/theme/theme.dart';
import 'package:final_project_app/providers/provider_auth.dart';

// App relative file imports
import 'screens/general/screen_alternate.dart';
import 'screens/general/screen_home.dart';
import 'screens/general/alter_game.dart';
...
import 'screens/general/player_information_screen.dart';
import 'screens/general/view_game.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  final GoRouter _router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: PlayerInformationScreen.routeName,
        builder: (BuildContext context, GoRouterState state) {
          final data = state.extra as Map<String, dynamic>;
          return PlayerInformationScreen(playerData: data);
        },
      ),
      GoRoute(
        path: viewGameScreen.routeName,
        builder: (BuildContext context, GoRouterState state) {
          final game = state.extra as Game;
          return viewGameScreen(dummyGame: game);
        },
      ),
    ],
  );
