...
import 'package:final_project_app/theme/colors.dart';
...
final ThemeData lightTheme = ThemeData(
  colorScheme: ColorScheme(
    ...
    onPrimary: Color.fromARGB(255, 172, 185, 204),
    // onPrimary: Color(0xFF022A3A),
    secondary: Color(0xFF022A3A),
    onSecondary: Color(0xFFFFFFFF),
    surface: CustomColors.primaryNavBarLightMode,
  ...
  cardColor: Color.fromARGB(255, 120, 142, 192),
  ...
  appBarTheme: AppBarTheme(
    backgroundColor: CustomColors.primaryNavBarLightMode,
  ),
...
InputDecorationTheme milLightInputDecorationTheme = InputDecorationTheme(
  filled: true,
  fillColor: Color.fromARGB(255, 120, 142, 192),
  border: const UnderlineInputBorder(
